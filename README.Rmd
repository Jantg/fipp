...
You can install the released version of fipp from [CRAN](https://CRAN.R-project.org) with:
...
[fipp Crash Course](https://CRAN.R-project.org/package=fipp/vignettes/fippCrashCourse.html)
